...
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
	...
	$yourEmail = "craig@medianetwifi.net"; // the email address you wish to receive these mails through
	$yourWebsite = "http://www.centrallimestoneco.com"; // the name of your website
